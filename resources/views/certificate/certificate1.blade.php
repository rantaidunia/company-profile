...
@section('title', 'ISO 9001:2015_YM-TEKNIK')
    ...
    <main class="main">
        ...
        <div class="page-title" data-aos="fade">
            <nav class="breadcrumbs">
                <div class="container">
                    <h2><b>ISO 9001:2015_YM-TEKNIK</b></h2>
                    <ol>
                        <li><a href="{{ url('/') }}">Home</a></li>
                        <li class="current text">ISO 9001:2015_YM-TEKNIK<br></li>
                    </ol>
                </div>
            </nav>
        </div><!-- End Page Title -->
            ...
            <div class="container">
                ...
                <div class="row gy-4">
                    <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-up" data-aos-delay="100">
                        <img src="{{ asset('assets/img/certificate/1.png') }}" class="img-fluid" alt="">
                    </div>
                </div>

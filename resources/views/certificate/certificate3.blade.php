...
@section('title', 'ISO 14001:2015_YM-TEKNIK')
    ...
    <main class="main">
        ...
        <div class="page-title" data-aos="fade">
            <nav class="breadcrumbs">
                <div class="container">
                    <h2><b>ISO 14001:2015_YM-TEKNIK</b></h2>
                    <ol>
                        <li><a href="{{ url('/') }}">Home</a></li>
                        <li class="current text">ISO 14001:2015_YM-TEKNIK<br></li>
                    </ol>
                </div>
            </nav>
        </div><!-- End Page Title -->
            ...
            <div class="container">
                ...
                <div class="row gy-4">
                    <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-up" data-aos-delay="100">
                        <img src="{{ asset('assets/img/certificate/3.png') }}" class="img-fluid" alt="">
                    </div>
                </div>
                ...
                <div class="col-lg-12 mt-4">
                    <div class="container d-flex pn">
                        <div class="d-flex" style="align-items: center;">
                            <a href="{{ url('/iso-45001-2018-ym-teknik') }}"><i class="bi bi-arrow-left-square-fill"></i></a>
                            <div class="container">
                                <h6 class="text" style="color: var(--accent-color);"><b>PREVIOUS</b></h6>
                                <h6 class="text">ISO 45001:2018_YM-TEKNIK</h6>
                            </div>
                        </div>
                        <div class="d-flex" style="align-items: center;">
                            ...
                            <a href="{{ url('/iso-45001-2018-ym-teknik') }}"><i class="bi bi-arrow-right-square-fill"></i></a> --}}
                        </div>
                    </div>
                </div>

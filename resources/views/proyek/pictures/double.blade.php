    ...
    <main class="main">
        <div class="page-title" data-aos="fade">
            <nav class="breadcrumbs">
                <div class="container">
                    <h2><b>Double Wall Tank</b></h2>
                    <ol>
                        <li><a href="{{ url('/') }}">Home</a></li>
                        <li class="current">Pictures<br></li>
                        <li class="current">Double Wall Tank<br></li>
                    </ol>
                </div>
            </nav>
        </div>
        ...
        <section id="events" class="events section">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="slick-picture">
                    ...
                    <img id="hover-3" src="{{ asset('assets/img/doublewall/1.png') }}" class="img-fluid" alt=""
                        data-aos="fade-up" data-aos-delay="100">


                    <img id="hover-3" src="{{ asset('assets/img/doublewall/2.png') }}" class="img-fluid" alt=""
                        data-aos="fade-up" data-aos-delay="100">


                    <img id="hover-3" src="{{ asset('assets/img/doublewall/3.png') }}" class="img-fluid" alt=""
                        data-aos="fade-up" data-aos-delay="100">


                    <img id="hover-3" src="{{ asset('assets/img/doublewall/4.png') }}" class="img-fluid" alt=""
                        data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="slick-nav">
                    ...
                    <img id="hover-3" src="{{ asset('assets/img/doublewall/1.png') }}" class="img-fluid imgs"
                        alt="" data-aos="fade-up" data-aos-delay="100">


                    <img id="hover-3" src="{{ asset('assets/img/doublewall/2.png') }}" class="img-fluid imgs"
                        alt="" data-aos="fade-up" data-aos-delay="100">


                    <img id="hover-3" src="{{ asset('assets/img/doublewall/3.png') }}" class="img-fluid imgs"
                        alt="" data-aos="fade-up" data-aos-delay="100">


                    <img id="hover-3" src="{{ asset('assets/img/doublewall/4.png') }}" class="img-fluid imgs"
                        alt="" data-aos="fade-up" data-aos-delay="100">
